...
class PartyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Party entity")
        ...
        .repeat(2) {
            ...
            .get("/services/jhipstersampleapplication/api/parties")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new party")
            .post("/services/jhipstersampleapplication/api/parties")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/jhipstersampleapplication${new_party_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created party")
            .delete("/services/jhipstersampleapplication${new_party_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
